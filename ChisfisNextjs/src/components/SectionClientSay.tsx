...
const SectionClientSay: FC<SectionClientSayProps> = ({
	...
	return (
		<div className={`nc-SectionClientSay relative ${className} `}>
			<Heading desc="Let's see what people think of Rent Punta Cana" isCenter>
				{translations.goodnewsFromFarAway}
			</Heading>
