...
const ContactForm: FC<ContactFormProps> = ({
	...
	return (
		<div className="flex w-full flex-col space-y-6 xl:space-y-7">
			...
			<div>
				<PhoneNumberInput className="mt-1.5" phoneNumber={contactPhone} />
			</div>
			...
			/>
			<ButtonPrimary className="stretch flex flex-1">
			...
			<ButtonSecondary className="whatsapp p-0">
				<Link
					...
					target="_blank"
					href={`https://wa.me/${contactPhone}?text=${translations.contactAgentPlaceholder}`}
				>
